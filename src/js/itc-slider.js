...
$(function () {
  ...
  $(".size-next").click(function () {
    if (flag == 0) {
      ...
      $(".c2").css({ transform: "translateX(380px) scale(1)", "z-index": "9" });
      ...
      $(".c1").css({ transform: "translateX(380px) scale(1)", "z-index": "9" });
      ...
      $(".c3").css({ transform: "translateX(380px) scale(1)", "z-index": "9" });
